   ...
   <nav class="navbar navbar-expand-lg navbar-light  bg-info">
    ...
    <ul id="nav">
        ...
        <li><a href="#">Mantenimientos</a>
            <ul>
                <li><a href="mant_administrador.php">Administración</a>
                    <ul>
...
//la variable  $mysqli viene de connect_db que lo traigo con el require("connect_db.php");
				...
				echo "<table border='1'; class='table table-hover';>";
					echo "<tr class='warning'>";
						echo "<td>Id</td>";
						echo "<td>Codigo_usuario</td>";
						echo "<td>Nombre de Cliente</td>";
						echo "<td>Correo</td>";
						echo "<td>Direccion</td>";
						echo "<td>Numero de Tel/Celular</td>";
						echo "<td>Fecha</td>";
						echo "<td>Seleccion de Productos</td>";
			...
			<?php 
				 while($arreglo=mysqli_fetch_array($query)){
				  	echo "<tr class='success'>";
						...
						echo "<td><a href='mant_administrador.php?id=$arreglo[7]&idborrar=7'><img src='../images/eliminar.png' class='img-rounded'/></a></td>";
