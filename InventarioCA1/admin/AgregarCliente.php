...
<html lang="es">
  ...
  <body>
    <header>
        ...
        <h4> FORMULARIO PARA AGREGAR CLIENTE </h4>
        </div>
    </header>
    <div class="Nav-user">
    <?php
    ...
    <?php 
    $count = "SELECT COUNT(*) total FROM cliente";
    ...
    <div class="col-xs-12">
      ...
      <form method="post" action="AgregarCliente">
        ...
        <input class="form-control" name="Nombre" type="text" placeholder="Nombre del Cliente">
        <br>
...
<?php
    if (isset($_POST['add'])) {
        ...
        $insert = "Insert Into cliente(IdCliente, NombreCliente, Usuario, password)
        values(".$code.", '".$nombre."', '".$usuario."', '".$contraseña."')";

        $sqli = mysqli_query($con, $insert);

        $comprobar = "Select * From cliente where NombreCliente = '".$nombre."' and IdCliente = '".$code."'";
