<html lang="es">
  ...
  <body>
    <header>
      ...
      <h4>Listado De Detalles de Compra</h4>
      </div>
    </header>
    <div class="col-xs-12">
	<div class="Nav-user">
    ...
    <form action="ListaDetalles de Compra" method="POST" align="center">
            <input type="text" title="Busqueda por Producto" autocomplete="off" autofocus class="form-control input-sm" name="bsc" placeholder="Buscar"><button class="btn btn-success">BUSCAR</button>
        </form>
        <br>
		<br>
