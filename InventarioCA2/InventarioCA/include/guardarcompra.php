...
$sql = "Insert Into compra (idcliente, fecha, valorcompra, estado, nombretc, numerotc, bancotc, tipotc, mestc, aniotc)values($idCliente,'$fecha',$valorcompra,'0', '$nombre', '$numero', '$emisor', '$tipo', '$mesv', '$aniov')";
