<html lang="es">
  ...
  <body>
    ...
    <form action="ModificarCliente" method="POST" align="center">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
          ...
          <td><button class="btn btn-danger" onclick="window.location.href='FormCliente?id=<?php echo $Id ?>'" >Modificar</button></td> 
          <?php } ?> 
        </tr>
      </tbody>
    </table>
