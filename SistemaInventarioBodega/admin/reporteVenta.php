...
$pdf->cell(55,8,"Nombre",0,0,"C");
$pdf->cell(50,8,"Monto",0,0,"C");
$pdf->cell(50,8,"Fecha",0,0,"C");
...
$pdf->cell(55,10,$fila['nombretc'],0,0,"C");
$pdf->cell(50,10,'$'.$fila['valorcompra'],0,0,"C");
$pdf->cell(50,10,$fila['fecha'],0,0,"C");
$pdf->ln(10); 
$pdf->ln(10);//Hacemos salto de linea
}
//Imprimir el total
