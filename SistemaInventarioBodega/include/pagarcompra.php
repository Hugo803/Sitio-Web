...
<input type="text" class="form-control" name="nombre" size="40" maxlength="50" required>
<br>

<label for="emisor">Banco Emisor :</label>

<input type="text" class="form-control" name="emisor" size="40" maxlength="35" required>
<br>

	<label for="numero">Numero :</label>

<input type="text" class="form-control" required name="numero" id="numero" size="20" maxlength="16" autocomplete="off" onblur="ValidarTJ(document.frmAutorizar.numero.value);">
<br>

	<label for="Tipo">Tipo :</label>

<select class="form-control" size="1" name="Tipo" required onblur="ValidarTJ(document.frmAutorizar.numero.value);">
...
<select class="form-select" required size="1" name="mesv">
	<option>01</option>
	<option>02</option>
	<option>03</option>
	<option>04</option>
...
/
<select class="form-select" size="1" name="aniov" required onblur="VenceTJ(document.frmAutorizar.mesv.value,document.frmAutorizar.aniov.value);">
	<option>
		<?php 
		echo date('Y');
		?></option>
