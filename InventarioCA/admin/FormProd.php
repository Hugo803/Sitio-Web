  ...
  <body>
    ...
    <div class="col-xs-12">
      <form method="post">
        ...
        <label for="Precio">Existenia:</label>
        <input class="form-control" name="Stock" type="text" value="<?php echo $result['Existencia'];?>">
...
<?php
  if($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if($NomPrd!=null || $Cat!=null || $Precio!=null || $Desc!=null || $Stock!=null){
        $U = "UPDATE producto Set Nombreproducto = '".$NomPrd."', DescripcionProducto = '".$Desc."', Precio = '".$Precio."', NombreCatergoria = '".$Cat."', Existencia = '".$Stock."' Where IdProducto = '".$idp."'";
